...
export function Header({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-none mx-auto w-full px-[calc(15*var(--unit-fx))] drop-shadow-[0_4px_80px_rgba(93,82,75,0.30)] max-[860px]:px-0 max-[860px]:drop-shadow-none min-[861px]:max-w-[calc(1660*var(--unit-fx))] min-[861px]:px-0",
          variant === "classes" && "classes-header-frame",
        )}
      >
        <div
          className={cn(
            "classes-header-surface pointer-events-auto relative grid grid-cols-[1fr_2fr] items-center rounded-[5px] bg-[var(--background)] px-[calc(22*var(--unit-fx))] text-[var(--ink)] min-[861px]:h-[calc(70.6875*var(--unit-fx))] max-[860px]:grid-cols-2 max-[640px]:px-[40px] min-[641px]:max-[860px]:px-[calc(19*var(--unit-fx))]",
          )}
        >
          <Link
            href="/"
