...
- [ ] The H1 says who the lessons are for and what kind of lesson experience to
  expect.
- [ ] No visible copy sounds like generic filler: "personalized approach",
  "passionate teacher", "high-quality lessons", "tailored to your needs" unless
  backed by a concrete example.
- [ ] Every trust claim has a specific support point: years, student ages,
...
- [ ] SVG placeholders are either replaced with approved real media or
  explicitly accepted for beta.
- [ ] Images or video show the real teacher, instrument, lesson situation or
  teaching material when available.
- [ ] Decorative elements do not distract from fit, trust and booking.

## Mobile Checks

- [ ] The top mobile viewport contains the H1, short explanation, trust signal
  and booking CTA without awkward overlap.
...
For each review pass, write a short result:
